...
__all__ = ['cbvitb16', 'cbvitl16']


class CbViT(nn.Module):
    __factory = {
        'cbvitb16': torchvision.models.vit_b_16,
        'cbvitl16': torchvision.models.vit_l_16,
    }
    ...
    def __init__(self, depth, pretrained=True, cut_at_pooling=False,
        ...
        if depth not in CbViT.__factory:
            raise KeyError("Unsupported depth:", depth)
        self.base = CbViT.__factory[depth](pretrained=pretrained)
...
def cbvitb16(**kwargs):
    return CbViT('cbvitb16', **kwargs)


def cbvitl16(**kwargs):
    return CbViT('cbvitl16', **kwargs)
